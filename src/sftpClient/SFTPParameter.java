...
public class SFTPParameter {
	...
	public String toString() {
		return "SFTPParameter [hostName=" + hostName + ", port=" + port + ", userName=" + userName + ", passWord=" + passWord
				+ ", sftpKeyFile=" + sftpKeyFile + ", downloadPath=" + downloadPath + ", savePath=" + savePath + ", uploadPath="
				+ uploadPath + ", conFTPTryCount=" + conFTPTryCount + ", conFTPTryInterval=" + conFTPTryInterval + ", sftp="
				+ sftp + ", isConnected=" + isConnected + "]";
	}
